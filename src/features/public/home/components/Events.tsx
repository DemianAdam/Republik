      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold text-white mb-4">
            Grilla <span className="text-red-600">Enero</span> 2026
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {events.map((event, index) => (
            <div
              key={index}
              className="group relative bg-gradient-to-b from-red-900/20 to-black border border-red-800/30 rounded-2xl overflow-hidden hover:border-red-600/50 transition-all duration-500 hover:scale-105"
            >
              ...
              <div className="p-6 space-y-4">
                <div>
                  <p className="text-red-600 text-sm font-semibold mb-1">{event.day}</p>
