      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-white/10 bg-zinc-900 shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-black/20 py-3 pl-10 pr-4 text-white placeholder-zinc-600 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 transition-all"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Shield className={`absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 z-10 ${createUser.role === ROLES_ENUM.ADMIN ? "text-emerald-500" : "text-zinc-500"}`} />
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-black/20 py-3 pl-10 pr-10 text-white placeholder-zinc-600 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 transition-all"
          ...
          <button
            type="submit"
            className="w-full mt-4 rounded-xl bg-emerald-600 py-3.5 font-semibold text-white shadow-lg shadow-emerald-900/20 transition-all hover:bg-emerald-500 hover:scale-[1.02] active:scale-[0.98]"
          >
