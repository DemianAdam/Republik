            ...
            <div className="flex items-center gap-2">
                ...
                <div className="flex items-center mr-2 transition-opacity duration-200">
                    ...
                    >
                        <button
                            ...
                            className="p-2 text-zinc-500 hover:text-red-400 hover:bg-red-600/10 rounded-lg transition-colors"
                        >
                ...
                <PermissionGuard
                    ...
                    <button
                        ...
                        className={`flex items-center justify-center rounded-lg px-4 py-2 text-sm font-medium transition-all active:scale-95 ${isInside ? 'bg-zinc-800/50 text-zinc-500 hover:text-white hover:bg-zinc-700' : 'bg-red-600 text-white shadow-lg shadow-red-900/20 hover:bg-red-600'}`}>
