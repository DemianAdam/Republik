    ...
    <div className="absolute inset-0 z-20 pointer-events-none">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex flex-col items-center z-30">
        ...
        <div className={`relative w-[85%] max-w-sm ${square ? "aspect-square" : "aspect-[3/1]"} rounded-xl shadow-[0_0_0_9999px_rgba(0,0,0,0.85)]`}>
          {/* Corner Markers */}
          <div className="absolute top-0 left-0 w-8 h-8 border-l-4 border-t-4 border-red-600 rounded-tl-lg" />
          <div className="absolute top-0 right-0 w-8 h-8 border-r-4 border-t-4 border-red-600 rounded-tr-lg" />
          <div className="absolute bottom-0 left-0 w-8 h-8 border-l-4 border-b-4 border-red-600 rounded-bl-lg" />
