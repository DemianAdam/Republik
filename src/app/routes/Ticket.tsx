...
//   if (guestQuery.isError) return <div>Error</div> //TODO: handle error UI
...
//         <button onClick={handleShare} disabled={isSharing} className="p-3 rounded-full bg-white/5 border border-white/10 text-white hover:bg-white/10 hover:scale-110 active:scale-95 transition-all backdrop-blur-md">
//           {isSharing ? <div className="h-5 w-5 rounded-full border-2 border-white/30 border-t-white animate-spin" /> : <Share2 className="h-5 w-5" />}
//         </button>
//       </div>
...
//         {/* 1. Breathing Glow Layer (FIXED: BIGGER) */}
//         {/* Changed from 'top-8' to '-top-6' to expand outwards */}
//         <div className={`
...
//                 <p className="text-[10px] text-zinc-500 font-mono uppercase tracking-widest break-all">
//                   {guest.qrCode.slice(0, 18)}...
//                 </p>
//               </div>
//             </div>
...
//           {/* 4. Stamp Overlay (FIXED: SINGLE LINE) */}
//           {isUsed && (
...
//       {/* ACTIONS */}
//       <div className="mt-2 flex flex-col items-center gap-4 z-20">
//         <button onClick={handleDownload} disabled={isDownloading} className="group relative px-8 py-3 bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 hover:border-zinc-700 text-white text-sm font-bold rounded-xl transition-all shadow-xl active:scale-95">
//           <div className="flex items-center gap-3">
//             {isDownloading ? <div className="h-4 w-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : <Download className="h-4 w-4 text-zinc-400 group-hover:text-white transition-colors" />}
